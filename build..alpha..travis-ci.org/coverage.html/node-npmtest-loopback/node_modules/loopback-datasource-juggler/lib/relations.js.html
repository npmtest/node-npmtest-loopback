...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-loopback/node_modules/loopback-datasource-juggler/lib/relations.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-loopback/node_modules/loopback-datasource-juggler/lib/relations.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">61.11% <small>(11 / 18)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-loopback/node_modules/loopback-datasource-juggler/lib/</a> &#187; relations.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  return RelationDefinition.hasMany(this, modelTo, params);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  return RelationDefinition.belongsTo(this, modelTo, params);</span>
};
&nbsp;
/**
 ...
 * @property {Object} model Model object
 */
RelationMixin.hasAndBelongsToMany = <span class="fstat-no" title="function not covered" >function hasAndBelongsToMany(modelTo, params) {</span>
<span class="cstat-no" title="statement not covered" >  return RelationDefinition.hasAndBelongsToMany(this, modelTo, params);</span>
};
&nbsp;
RelationMixin.hasOne = <span class="fstat-no" title="function not covered" >function hasOne(modelTo, params) {</span>
<span class="cstat-no" title="statement not covered" >  return RelationDefinition.hasOne(this, modelTo, params);</span>
};
&nbsp;
RelationMixin.referencesMany = <span class="fstat-no" title="function not covered" >function referencesMany(modelTo, params) {</span>
<span class="cstat-no" title="statement not covered" >  return RelationDefinition.referencesMany(this, modelTo, params);</span>
};
&nbsp;
RelationMixin.embedsOne = <span class="fstat-no" title="function not covered" >function embedsOne(modelTo, params) {</span>
<span class="cstat-no" title="statement not covered" >  return RelationDefinition.embedsOne(this, modelTo, params);</span>
};
&nbsp;
RelationMixin.embedsMany = <span class="fstat-no" title="function not covered" >function embedsMany(modelTo, params) {</span>
<span class="cstat-no" title="statement not covered" >  return RelationDefinition.embedsMany(this, modelTo, params);</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
